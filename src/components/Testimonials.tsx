...
const TESTIMONIALS = [
  {
    ...
    role: 'Connoisseur & Private Banker',
    comment: 'Terra Noir is an absolute revelation. The depth of body and intricate cocoa tasting notes rival the rarest coffees I have had in Europe. It is the only label served in my personal lounge.',
    rating: 5,
  ...
  },
  {
    id: 'test-2',
    name: 'Helena Rostova',
    role: 'Michelin-starred Pastry Chef',
    comment: 'The organic powder has completely transformed our cold desserts. Its delicate caramels and smooth finish stay perfectly aromatic. It is truly liquid gold for gastronomes.',
    rating: 5,
  ...
  },
  {
    ...
    comment: 'As a designer, I am fascinated by both the branding and the blend. The premium cold brew is a masterpiece—perfectly balanced, naturally sweet, and incredibly rich. Highly recommended.',
    rating: 5,
