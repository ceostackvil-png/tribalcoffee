          ...
          >
            ...
            <div className="w-full max-w-md glassmorphism border border-warm-gold/20 p-8 rounded-[40px] shadow-[0_25px_60px_rgba(0,0,0,0.8)] relative">
              ...
              <p className="text-xs text-cream-latte/65 mb-8">
                Enter secure 4-digit PIN to access roasting databases, analytics, & logistics.
              </p>
              ...
              <div className="flex justify-center gap-5 mb-8">
                {[0, 1, 2, 3].map((idx) => (
                  <div
                    key={idx}
                    className={`w-3.5 h-3.5 rounded-full border border-warm-gold/40 transition-all duration-300 ${
                      pinCode.length > idx 
                        ? 'bg-warm-gold shadow-[0_0_10px_#D6B27A]' 
                        : 'bg-transparent'
                    }`}
                  />
                ))}
              ...
              <AnimatePresence>
                {pinError && (
                  <motion.div
                    ...
                    exit={{ opacity: 0, y: -10 }}
                    className="bg-red-950/40 border border-red-500/25 px-4 py-2 rounded-xl flex items-center justify-center gap-2 mb-6 text-xs text-red-300 font-sans"
                  >
                    <AlertCircle size={14} />
                    Invalid PIN. Authentication rejected.
                  </motion.div>
                )}
              </AnimatePresence>
              ...
              <div className="grid grid-cols-3 gap-4 max-w-xs mx-auto">
                {['1', '2', '3', '4', '5', '6', '7', '8', '9'].map((num) => (
                  <button
                    ...
                    className="w-16 h-16 rounded-full border border-cream-latte/5 bg-cream-latte/5 flex items-center justify-center font-playfair text-xl hover:bg-warm-gold hover:text-espresso hover:border-warm-gold transition-all duration-200 cursor-pointer mx-auto shadow-md"
                  >
                    {num}
                  </button>
                ))}
                <button
                  ...
                  className="col-start-2 w-16 h-16 rounded-full border border-cream-latte/5 bg-cream-latte/5 flex items-center justify-center font-playfair text-xl hover:bg-warm-gold hover:text-espresso hover:border-warm-gold transition-all duration-200 cursor-pointer mx-auto shadow-md"
                >
                  0
                </button>
                <button
                  onClick={deletePinChar}
                  className="w-16 h-16 rounded-full bg-cream-latte/5 flex items-center justify-center text-xs hover:bg-red-950/20 hover:text-red-300 border border-transparent transition-all duration-200 cursor-pointer mx-auto"
                >
                  Clear
                </button>
              </div>
              ...
              <div className="mt-8 text-[9px] text-cream-latte/30 tracking-wider">
                Hint: Established Year of Co-op initiatives (1975)
              </div>
            </div>
          </motion.div>
        )}
